...
if __name__ == '__main__':
    ...
    # model = YOLO(r'yolov8s-pixel-DA.yaml').load("yolov8s.pt")  # 使用预训练权重训练
    # model = YOLO(r'yolov8s-region-seg.yaml').load("best.pt")  # 使用预训练权重训练
    # model = YOLO(r'yolov8s-region-seg-ASPP.yaml').load("yolov8s.pt")  # 使用预训练权重训练

    # Trainparameters ------------------------------------------------------------
    # ----------------------------------

    model.train(
        data=r'Japan-Japanfoggy_DA-mini.yaml',
        # data=r'Japan-Japanrain_DA.yaml',
        # data=r'CNRDD-CNRDDfoggy_DA.yaml',
        # data=r'CNRDD-CNRDDrain_DA.yaml',
